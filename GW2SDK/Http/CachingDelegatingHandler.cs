...
namespace GW2SDK.Http
{
    ...
    {
        private readonly Dictionary<string, List<ResponseCacheEntry>> _responseCache = new();
        ...
        )
        {
            ...
            if (_responseCache.TryGetValue(primaryKey, out var cacheEntries))
            {
                var match = false;
            ...
            {
                _responseCache[primaryKey] = new List<ResponseCacheEntry>();
            }
